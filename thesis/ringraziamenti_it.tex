...
tutte le dipendenze legate alle funzioni biologiche ed infine, dopo 9
...
spinge come un treno ed ha più energia in corpo di quanta se ne possa
...
giusto, facendolo quindi per il bene. Ad oggi, quali meriti posso
attribuirle dopo tutto ciò? Posso dire: di sapere come pormi con il
prossimo, mostrando rispetto ed inclusione -- salvo per chi non ritengo
degno --; di mantenere una disciplina ferrata quando serve; di avere
...
Ringrazio adesso zia Alessandra, zio Mario e i miei cugini Andrea e
...
i rapporti con ognuno attraverso i ricordi bellissimi di esperienze
...
quello con la dad lore più grande di tutti), Giuseppe (detto il Giuse,
il potentino in trasferta), Francesco (detto FrancyAI, a cui ci
rivolgiamo quando finiamo i token), Francesco Paoletti (il Francesco
scomparso) e Michele (che ormai è diventato cosmopolita), il primo
...
(detto Matteo Greek, dal pizzetto che gli è diventato marchio di
...
\item ``La vita è come una scatola di ciocolatini\dots non sai mai quale ti capita.'' $\sim$ \emph{Forrest Gump} | Forrest Gump
