...
Il tirocinio, svolto in forma individuale presso il Dipartimento di
Informatica della Sapienza Universit\`a di Roma, si \`e interessato del
progetto ProSafe~\cite{prosafe}, il sistema di boe intelligenti per la
sicurezza di prossimit\`a nelle acque costiere. Il protocollo di partenza limita
...
il \emph{forwarding singolo}, che inoltra i beacon ricevuti entro un limite
di hop con meccanismi di contenimento del broadcast storm~\cite{broadcaststorm}, e il
\emph{forwarding aggregato}, che allega a ogni beacon la lista dei nodi
conosciuti senza generare frame aggiuntivi (Capitolo~\ref{ch:contributo}). Entrambe
...
scheduling su cinque livelli di densit\`a, con 30 repliche indipendenti per
...
60--76\% di rete scoperta nel canale ideale e al 49--66\% in quello con
...
(a 100 boe nel canale ideale, collision rate 0.157 contro 0.557 con SBP e
0.033 contro 0.400 con ACAB) e diffonde la conoscenza pi\`u rapidamente
(latenza di reazione di circa \SI{16}{ms} contro 86--114~\si{ms}): affidare
la disseminazione all'allungamento dei frame anzich\'e a trasmissioni
aggiuntive si \`e rivelata la scelta pi\`u efficiente rispetto a tutti i criteri
misurati. Il forwarding singolo conserva la semplicit\`a del meccanismo e un
B-PDR migliore nei soli scenari sparsi con canale con perdite.
...
aggregato --- mantenendo il B-PDR sopra 0.95 nel canale ideale fino a 100 boe
...
propagazione reale, e il modello di mobilit\`a Random Waypoint~\cite{rwp} approssima ma
...
Sul piano del progetto, il tirocinio ha prodotto un
...
progettazione di nuovi meccanismi e l'analisi statistica dei
risultati. Questa esperienza dimostra che la simulazione si rivela uno strumento essenziale per lo studio
di nuovi protocolli di rete l\`a dove la sperimentazione diretta risulta impraticabile.
