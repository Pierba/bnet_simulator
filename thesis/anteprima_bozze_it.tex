...
\input{bozza_capitolo6_it}

% ---------------------------------------------------------------------
% Bibliografia: sottoinsieme delle voci di main.tex citate nel Cap. 2,
% qui solo per risolvere i \cite in anteprima (non e' la bibliografia
% finale della tesi).
% ---------------------------------------------------------------------
